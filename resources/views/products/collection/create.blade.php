            ...
            <div class="row">
                <div class="col-lg-7 col-sm-12 m-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Main Image Color Code<span class="text-danger">*</span></label>
...
<script>
    ...
    const storeEndpoint = '{{ route("store.collection.products") }}'; // New AJAX endpoint
        ...
        $('.variant-block').each(function() {
            ...
            if (colorName && colorCode && mainImage) {
                ...
                $(this).find(`input[name="colors[${index}][other_images][]"]`).each(function() {
                  ...
                  $(this)
        .find(`select[name="colors[${index}][unavailable_sizes][]"] option:selected`)
        .each(function () {
            formData.append(
...
// formData.append('colors', JSON.stringify([]));        }
        ...
        try {
            ...
            window.location.href = '{{ route("admin.collections.products.view") }}';
        } catch (error) {
